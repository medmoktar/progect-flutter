...
class Updateecole extends StatefulWidget {
  final id, idvillage;
  ...
  @override
  State<Updateecole> createState() => _Updateecole();
}

class _Updateecole extends State<Updateecole> {
  ...
  var reponse;
  get(id) async {
    var x = await http.get(Uri.parse('${Url().URL}/api/store/Ecole/$id'));
  ...
  update(id, File Img) async {
    ...
    var url = Uri.parse('${Url().URL}/api/update/Ecole/$id');
